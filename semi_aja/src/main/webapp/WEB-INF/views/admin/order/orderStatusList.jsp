...
<body>
    ...
    <table class="order-table">
        ...
        <form action = "<%=request.getContextPath()%>/order/orderrefund.do" onsubmit ="refundOrder(event);">
    ...
    <script>
   	refundOrder=(event)=>{
   		...
   		for(let i=0;i<orders.length;i++){
   		 ...
   		 location.assign(url+"?"+"orders="+values); 
   	}
    ...
    $(document).ready(function(){
    	$("#orderType").change(function(){
    		...
    		$.ajax({
    			url : "<%=request.getContextPath()%>/order/orderstatusajax.do",
    			type: "post",
    			data: {
